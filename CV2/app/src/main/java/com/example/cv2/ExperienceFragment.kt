...
class ExperienceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ExperienceList.add(Experiences(ExpPic = R.drawable.ic_logo_cambridge,ExpName = "AMAZONE",ExpLoc = "United States",ExpFirstDate = "01/09/2019",ExpLastDate = "TODAY",ExpDesc = "AMAZONE"))
        ...
        ExperienceList.add(Experiences(ExpPic = R.drawable.ic_logo_massachusetts,ExpName = "Facebook",ExpLoc = "United States",ExpFirstDate = "01/09/2019",ExpLastDate = "TODAY",ExpDesc = "FACEBOOK"))
        ExperienceList.add(Experiences(ExpPic = R.drawable.ic_logo_google,ExpName = "Facebook",ExpLoc = "United States",ExpFirstDate = "01/09/2019",ExpLastDate = "TODAY",ExpDesc = "FACEBOOK"))
        ExperienceList.add(Experiences(ExpPic = R.drawable.ic_logo_linkedin,ExpName = "Facebook",ExpLoc = "United States",ExpFirstDate = "01/09/2019",ExpLastDate = "TODAY",ExpDesc = "FACEBOOK"))
